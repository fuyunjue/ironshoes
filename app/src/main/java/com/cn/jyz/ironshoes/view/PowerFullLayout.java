...
public class PowerFullLayout extends LinearLayout {
	...
	private float preScale = 1f;// 默认前一次缩放比例为12323
...
//						ViewHelper.setScrollX(PowerFullLayout.this, downX-moveX);// x方向上缩放
//						ViewHelper.setScrollY(PowerFullLayout.this, downY-moveY);// x方向上缩放
						downX = moveX;
						downY = moveY;
					default:
						break;
