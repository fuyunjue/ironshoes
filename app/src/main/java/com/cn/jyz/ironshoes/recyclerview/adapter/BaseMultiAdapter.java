...
import com.cn.jyz.ironshoes.recyclerview.bean.RecordEntity;
import com.cn.jyz.ironshoes.recyclerview.interfaces.IExpandable;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

public abstract class BaseMultiAdapter<T extends RecordEntity> extends RecyclerView.Adapter<SuperViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        if (item instanceof RecordEntity) {
            return ((RecordEntity)item).getItemType();
        }
